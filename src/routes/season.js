...
router.get("", (req, res) => {
    ...
    if (driverStandings || constructorStandings) {
        ...
        if (year || circuit || driver || constructor || status || result || grid || fastest)
            sql += " AND seasons.year=races.year";
    ...
    conn.query(sql, (err, rows, fields) => {
        ...
        if (constructorStandings) json.MRData.SeasonTable.constructorStandings = constructorStandings;
        if (driverStandings) json.MRData.SeasonTable.driverStandings = driverStandings;
