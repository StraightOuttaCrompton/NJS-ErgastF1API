...
router.get("", (req, res) => {
    ...
    if (driverStandings || constructorStandings) {
        ...
        if (constructor && constructorStandings)
            sql += " AND constructors.constructorId=constructorStandings.constructorId";
    } else {
    ...
    conn.query(sql, (err, rows, fields) => {
        ...
        if (constructorStandings) json.MRData.DriverTable.constructorStandings = constructorStandings;
        if (driverStandings) json.MRData.DriverTable.driverStandings = driverStandings;
